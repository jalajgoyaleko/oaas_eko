...
const Camera = ({
  ...
  const { imge, setImg, setManageVeriyStep, setManageVeriyStepback } =
    useStore();
          ...
          {type !== "Aadhaar" ? (
            <>
              {type !== "videoRecord" ? (
                <span
                  className={`flex ${
                    type !== "Aadhaar" ? "justify-end" : "justify-center"
                  } mt-3`}
                >
                  <ButtonGlobal onClick={capture} className="cam_btn">
                    <>
        ...
        <>
          ...
          <span className="flex justify-end mt-3">
            <ButtonGlobal onClick={handleRetake} className="cam_btn">
              <>
                <img src={retry} alt="retry_icon" className="w-[16px] h-[16px] mr-1" />{" "}
                Re-Capture
              </>
            </ButtonGlobal>
          </span>
